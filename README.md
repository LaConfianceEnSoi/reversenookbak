### 손진욱을 잡아라 수박게임의 리버스 모드입니다. 
### 같은 모양의 과일 두 개가 만나서 합쳐지면 득점하는 건 같은데, 기본 모드와 달리 큰 과일이 만나서 작은 과일로 변합니다.
### 큰 과일이 쌓이지 않고 작아지니 플레이어에 따라 게임이 더 쉽게 느껴질 수도 있겠죠? 
### 원소스코드에 내용을 조금만 수정하면 리버스모드를 지원하게 되어 있어서 '그런데 이게 게임으로서 재미가 있을까?'하고 의구심을 가지면서도 그냥 올려봤는데
### 생각보다 반응이 폭발적이군요. ㅋㅋㅋ
